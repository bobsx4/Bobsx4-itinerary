...
Bobsx4 Road Companion is an offline-first family travel companion. It combines adult itinerary and stay tools with profile-based Adventure experiences, daily assignments, Road Quest counters, journals, badges, and a post-trip scrapbook.
...
- **Memories:** profile-specific statistics, badges, observations, assignment answers, ratings, and scrapbook entries.
...
- assignment response fields for predictions, comparisons, times, rankings, and field observations;
...
- quick facts and answer boxes;
- photo challenges;
- favourite moments, food, purchases, surprises, and memories;
- Explorer badges and next-day teasers.

Rename either profile locally in Settings. Names, journals, tallies, assignment answers, confirmation numbers, and notes remain on that device and are not published to GitHub.

## Assignment and question responses

RC3 adds a way to answer assignments where checking a box was not enough. Examples include:

- predicted and actual arrival times;
- a clear change caused by elevation;
- ferry wait estimates and actual waits;
- top-three ride rankings;
- animal behaviour observations;
- route and landscape changes;
- family trip verdicts.

Response panels appear only on assignments that need a notation. They support text, longer observations, times, numbers, and selected choices. Answers save automatically on the current device and are carried into Memories. Route-intelligence and fact questions also have optional answer boxes.
...
The public site contains only the app and public itinerary. Each phone or iPad keeps its own journals, badges, sightings, assignment responses, checklist state, hotel confirmations, and notes. Sharing the URL gives family members the same app but not the same local progress.
