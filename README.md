...
RC3.2 was rebuilt from the user-supplied, known-good **v0.3.0 RC2** archive. RC3.3 applies only the Adventure scroll-preservation and Live Check lifecycle changes to that accepted RC3.2 source.
...
- **Settings:** local profile names and experience styles, update controls, official live checks with an automatic Past checks archive, backup/restore, notes, and local-data reset.
