window.ROAD_TRIP = {
  ...
  routeOverview: [
    ...
    { id: "kalispell", name: "Kalispell", region: "MT", lat: 48.1920, lon: -114.3168, type: "overnight" },
    { id: "silverwood", name: "Silverwood", region: "ID", lat: 47.9088, lon: -116.5960, type: "highlight" },
    { id: "coeurdalene", name: "Coeur d'Alene", region: "ID", lat: 47.6777, lon: -116.7805, type: "overnight" },
  ...
  days: [
    ...
    },
    {
      ...
      timeline: [
        ...
        { time: "Afternoon", title: "Lake McDonald", detail: "Stop at the lodge or shoreline, then continue to Kalispell." },
        { time: "Evening", title: "Arrive in Kalispell", detail: "Check in for one night and keep the evening flexible." }
      ],
      mustDo: [
    ...
    },
    {
      ...
      stops: ["Kalispell, MT", "Coeur d'Alene, ID"],
      timeline: [
        { time: "Morning", title: "Breakfast in Kalispell", detail: "Keep the morning relaxed after the long Glacier day." },
        { time: "Late morning", title: "Drive west", detail: "Enjoy the mountain route and remember the one-hour time change." },
        { time: "Mid-afternoon", title: "Arrive in Coeur d'Alene", detail: "Check in for two nights and unload before heading out." },
        { time: "Evening", title: "Coeur d'Alene evening", detail: "Choose downtown shopping, dinner, or a short lakeside walk without committing to another beach day." }
      ],
      mustDo: [
      ...
      optional: ["Downtown Coeur d'Alene boutiques, dinner, or a brief waterfront walk."],
      alerts: ["This is now a flexible travel and reset day; the Missoula concert has been removed from the itinerary."],
    ...
    },
    {
      ...
      stops: ["Coeur d'Alene, ID", "Silverwood Theme Park, Athol, ID", "Coeur d'Alene, ID"],
      timeline: [
        { time: "Morning", title: "Leave Coeur d'Alene", detail: "The park is roughly 35 to 45 minutes north, depending on traffic." },
        { time: "Park opening", title: "Silverwood and Boulder Beach", detail: "Use a locker for dry clothes and valuables and agree on a family meeting point." },
        { time: "Afternoon", title: "Water park and rides", detail: "Balance thrill rides with enough downtime for everyone." },
        { time: "After close", title: "Return to Coeur d'Alene", detail: "No hotel change tonight; return to the same room." }
      ],
      mustDo: [
      ...
      optional: ["Easy late supper in Coeur d'Alene after the park."],
      alerts: ["The two-night stay eliminates packing and a late-night drive to Spokane Valley."],
    ...
    },
    {
      ...
      timeline: [
        { time: "Morning", title: "Check out in Coeur d'Alene", detail: "Load the vehicle once, then head west for the planned shopping loop." },
        ...
        { time: "Afternoon", title: "Finish the shopping loop", detail: "Use Post Falls or Coeur d'Alene stops only where they fit naturally on the route north." },
        { time: "Late afternoon", title: "Drive to Sandpoint", detail: "Continue north for the overnight and downtown browsing or dinner." }
      ],
      mustDo: [
      ...
      optional: [
        ...
        "Cabela's in Post Falls if it fits the route and energy level.",
        "Downtown Sandpoint shopping and dinner after check-in."
      ],
      alerts: ["There is no Spokane Valley overnight; all shopping happens en route from Coeur d'Alene to Sandpoint."],
