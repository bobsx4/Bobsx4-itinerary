window.ROAD_TRIP = {
  ...
  routeOverview: [
    ...
    { id: "spokanevalley", name: "Spokane Valley", region: "WA", lat: 47.6732, lon: -117.2394, type: "highlight" },
  ...
  days: [
    ...
    },
    {
      ...
      date: "2026-08-02",
      shortDate: "Aug 2",
      title: "Silverwood and Coeur d'Alene",
      start: "Missoula, MT",
      end: "Coeur d'Alene, ID",
      overnight: "Coeur d'Alene, ID",
      distanceKm: 325,
      driveTime: "about 3 hr 15 min total",
      departure: "around 8:00 AM MDT",
      arrival: "after park close",
      tone: "rides",
      summary: "Gain an hour crossing into Pacific Time, spend the day at Silverwood and Boulder Beach, then continue to Coeur d'Alene.",
      timeZoneNote: "You gain one hour travelling from Montana to northern Idaho. Silverwood uses Pacific Time.",
      stops: ["Missoula, MT", "Silverwood Theme Park, Athol, ID", "Coeur d'Alene, ID"],
      timeline: [
        ...
        { time: "After close", title: "Drive to Coeur d'Alene", detail: "The city is roughly 30 minutes south of the park. Check in and call it a night." }
      ],
      mustDo: [
      ...
      optional: ["Quick late-evening look at the Coeur d'Alene waterfront if everyone still has energy."],
      alerts: ["The long park day follows the concert. A comfortable Coeur d'Alene hotel and a relaxed next morning matter more than squeezing in extra nightlife."],
      hotelHint: "Choose easy parking. Downtown is attractive, but a clean hotel near I-90 may be better value after a full park day."
    },
    {
      id: "day-5",
      date: "2026-08-03",
      ...
      distanceKm: 180,
      driveTime: "about 2.5 hr driving, plus shopping",
      departure: "morning",
      arrival: "late afternoon or evening",
      tone: "shopping",
      summary: "Enjoy a little lakefront time, shop the Spokane Valley cluster, then turn north for Sandpoint.",
      ...
      timeline: [
        { time: "Morning", title: "Coeur d'Alene waterfront", detail: "Short walk, breakfast, or lake view before heading west." },
    ...
    },
    {
      ...
      overnight: "Nelson, BC",
      distanceKm: 230,
      driveTime: "about 3 hr, plus border",
      departure: "late morning",
      arrival: "mid-afternoon",
      tone: "lakes",
      summary: "A shorter scenic day through Bonners Ferry, the Porthill/Rykerts crossing, Creston, and the Kootenays.",
      ...
      timeline: [
        { time: "Morning", title: "Sandpoint City Beach", detail: "Swim, walk, or enjoy breakfast before leaving the United States." },
        ...
        { time: "Mid-afternoon", title: "Arrive in Nelson", detail: "Check in, then explore Baker Street or the waterfront on foot." }
      ],
      mustDo: [
      ...
      optional: ["Creston fruit stand or a short local-food stop."],
      alerts: ["Border processing time is not included in the drive estimate.", "Use a daytime crossing. Official U.S. and Canadian listings showed different closing times when this app was built, so recheck both before August 4."],
